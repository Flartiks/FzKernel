...
$(KERNEL_BIN): $(BOOT_OBJ) $(KERNEL_OBJ) $(GRAPHICS_OBJ) $(PIT_OBJ) $(PIC_OBJ) $(PORTS_OBJ) $(IDT_OBJ) \
               $(IRQ0_HANDLER_OBJ) $(IRQ1_HANDLER_OBJ) $(KEYBOARD_OBJ) $(STACK_PROTECTOR_OBJ) $(UTILS_OBJ) $(SHELL_OBJ) $(RTC_OBJ) | $(BUILD_DIR)
	$(LD) $(LDFLAGS) -o $@ $(BOOT_OBJ) $(KERNEL_OBJ) $(GRAPHICS_OBJ) $(PIT_OBJ) $(PIC_OBJ) $(PORTS_OBJ) \
	$(IDT_OBJ) $(IRQ0_HANDLER_OBJ) $(IRQ1_HANDLER_OBJ) $(KEYBOARD_OBJ) $(STACK_PROTECTOR_OBJ) $(UTILS_OBJ) $(SHELL_OBJ) $(RTC_OBJ)
